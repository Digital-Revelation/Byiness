...
{
    // Call into TxToUniv() in byiness-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in byiness-common, so we query them here and push the
...
static UniValue getrawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{
            ...
            "           \"address\"        (string) byiness address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
...
static UniValue decoderawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{"decoderawtransaction",
            ...
            "         \"type\" : \"pubkeyhash\",  (string) The type, eg 'pubkeyhash'\n"
            "         \"addresses\" : [           (json array of string)\n"
            "           \"12tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc\"   (string) byiness address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
