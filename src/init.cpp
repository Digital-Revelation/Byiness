 ...
 */
static const char* BITCOIN_PID_FILENAME = "byinessd.pid";
...
{
    const std::string URL_EXPLORER= "<https://scan.byinesscoin.com>";
    const std::string URL_WEBSITE = "<https://byinesscoin.com>";
    const std::string URL_MININGPOOL = "<https://mine.byinesscoin.com>";
    const std::string URL_WEBWALLET = "<https://thebyinesswallet.com>";
    const std::string URL_TELEGRAM = "<https://t.me/byinesscoin>";
    const std::string URL_GITHUB = "<https://github.com/Digital-Revelation/Byiness>";
       ...
       return     "\n" +
           ...
           "\n" +
           "\n" +
           strprintf(_("Source code: %s").translated,
               URL_GITHUB) +
           "\n" +
           "\n" +
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    if (fs::exists(config_file_path)) {
        ...
        if (configFile != NULL) {
            std::string strHeader = "# Byiness Coin - Digital Revelation config file:\n"
                                    "rpcuser=username\n"
                                    ...
                                    "\n"
                                    "# Addnodes:\n"
                                    "addnode=seed01.byinesscoin.com\n"
                                    "addnode=seed02.byinesscoin.com\n"
                                    "addnode=seed03.byinesscoin.com\n"
                                    "addnode=seed04.byinesscoin.com\n"
                                    "\n";
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if byiness is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if byiness is started while in a temporary directory.\n",
