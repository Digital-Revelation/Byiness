    ...
    m_network_style(networkStyle)
{
    ...
    // See https://doc.qt.io/qt-5/gallery.html
        progressBar->setStyleSheet("QProgressBar { background-color: #141414; font-size: 8px; font-family: Diversa Sans Com Black, sans-recif; font-weight: normal; max-height: 5px; color: #eee; letter-spacing: 6px; border: 1px solid grey; border-radius: 4px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #212121, stop: 1 #FFD800); border-radius: 4px; margin: 0px; max-height: 5px; min-width: 300px; letter-spacing: 6px;  }");
...
void BitcoinGUI::createActions()
{
 ...
 //   overviewAction->setStyleSheet("QActionGroup { text-align:center; }");
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Byiness Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and byiness: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Byiness Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Byiness Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a byiness: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Byiness Coin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Byiness Coin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
