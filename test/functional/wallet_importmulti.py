...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["rbyiness1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7scl8gn", "rbyiness1qfqeppuvj0ww98r6qghmdkj70tv8qpchehegrg8"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'rbyiness1qtmp74ayg7p24uslctssvjm06q5phz4yrxucgnv', # m/0'/0'/0
            'rbyiness1q8vprchan07gzagd5e6v9wd7azyucksq2xc76k8', # m/0'/0'/1
            'rbyiness1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjp9lulu', # m/0'/0'/2
            'rbyiness1qau64272ymawq26t90md6an0ps99qkrse58m640', # m/0'/0'/3
            'rbyiness1qsg97266hrh6cpmutqen8s4s962aryy77jp0fg0', # m/0'/0'/4
        ]
        result = wrpc.importmulti(
            [{
