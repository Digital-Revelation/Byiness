...
"""Verify that starting byiness with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start byiness with -h for help text")
        ...
        self.log.info("Start byiness with -version for version information")
        ...
        self.log.info("Start byinessd with -fakearg to make sure it does not start")
