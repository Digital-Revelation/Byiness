...
bech32_templates = [
  ...
  ('"byiness',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"byiness',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"byiness',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbyiness',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbyiness',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbyiness',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbyiness',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbyiness',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbyiness', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbyiness',   17, 32, False, False, False),
  ('rbyiness',  3,  1, False, False, False),
  ('byiness',   15, 41, False, False, False),
  ('tbyiness',    0, 16, False, False, False),
  ('rbyiness',  0, 32, True,  False, False),
  ('byiness',    0, 16, True,  False, False),
  ('tbyiness',    0, 32, False, True,  False),
  ('rbyiness',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['byiness', 'tbyiness', 'rbyiness']:
