...
void RPCConsole::clear(bool clearHistory)
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        QString(
                "table { }"
                "td.time { font-family: Calibri Light, sans-recif; font-size: 12px; color: #808080; padding-top: 3px; } "
                "td.message { font-family: Calibri, sans-recif; font-weight: normal; font-size: 13px; color: #2A2A2A; white-space:pre-wrap; } "
                "td.cmd-request { color: #808080; font-size: 12px; font-family: Calibri Light, sans-recif; } "
                "td.cmd-error { color: #C0817A; font-family: Calibri Light, sans-recif; font-size: 12px; } "
                ".secwarning { color: #C0817A; font-family: Calibri Light, sans-recif; font-size: 12px; }"
                "b { color: #eec82c; font-family: Calibri, sans-recif; font-size: 13px; } "
