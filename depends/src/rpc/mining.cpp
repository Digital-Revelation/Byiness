...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated byiness to."},
            ...
            + "If you are running the Byiness Coin - Digital Revelation wallet, you can get a new address to send the newly generated byiness to with:\n"
